...
<template>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div>
            <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 rounded-lg px-0">
                <div
                    ...
                    <div v-if="enableSearch" class="flex items-center flex-1 space-x-4">
                        <div class="relative w-full">
                            ...
                            <input type="text" v-model="query.search" @keyup="searchRecord"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full sm:w-80 ps-10 px-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody v-if="list.items.length > 0">
                            <tr v-for="(item, index) in list.items" :key="item.id"
                                ...
                                <td scope="row"
                                    class="px-4 py-4 font-normal text-gray-900 whitespace-nowrap dark:text-white text-center">
                ...
                <div class="flex flex-col justify-between p-4 space-y-3 sm:flex-row sm:items-center sm:space-y-0">
                    <div
                        ...
                        <div>
                            <span class="font-semibold text-gray-900 dark:text-white">{{ list.from }} - {{ list.to
                                }}</span>
                            <span> of </span>
                            <span class="font-semibold text-gray-900 dark:text-white">{{ list.totalRecord }}</span>
                        </div>
                    </div>
